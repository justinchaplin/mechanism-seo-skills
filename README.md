...
### Step 2 — Install Node.js and Claude Code (one-time setup)

> **Important:** Steps 2 and 3 are a one-time setup only. You're installing the tools that connect your local skill files to Claude. After this, you never open a terminal again — all actual skill usage happens at [claude.ai](https://claude.ai) in your browser.
...
> **You're done with the terminal.** Everything from here happens at [claude.ai](https://claude.ai) in your browser. Claude Code runs silently in the background — you don't interact with it directly.
